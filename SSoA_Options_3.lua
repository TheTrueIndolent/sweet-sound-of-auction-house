...
-- sort & clicking --
-- choice 0 12 --
ssoaOptions3Box2PopOut1Choice0:HookScript("OnClick", function(self, button, down)
	if button == "LeftButton" and down == false then
		SSoAframeOpt["Fonts"] = 12
		ssoaOptions3Box2PopOut1.Text:SetText(self:GetText())
		ssoaOptions3Box2PopOut1Choice0:Hide()
	end
end)
-- choice 1 14 --
ssoaOptions3Box2PopOut1Choice1:SetParent(ssoaOptions3Box2PopOut1Choice0)
ssoaOptions3Box2PopOut1Choice1:SetPoint("TOP", ssoaOptions3Box2PopOut1Choice0, "BOTTOM", 0, 0)
ssoaOptions3Box2PopOut1Choice1:HookScript("OnClick", function(self, button, down)
	if button == "LeftButton" and down == false then
		SSoAframeOpt["Fonts"] = 14
		ssoaOptions3Box2PopOut1.Text:SetText(self:GetText())
		ssoaOptions3Box2PopOut1Choice0:Hide()
	end
end)
-- choice 2 16 --
ssoaOptions3Box2PopOut1Choice2:SetParent(ssoaOptions3Box2PopOut1Choice0)
ssoaOptions3Box2PopOut1Choice2:SetPoint("TOP", ssoaOptions3Box2PopOut1Choice1, "BOTTOM", 0, 0)
ssoaOptions3Box2PopOut1Choice2:HookScript("OnClick", function(self, button, down)
	if button == "LeftButton" and down == false then
		SSoAframeOpt["Fonts"] = 16
		ssoaOptions3Box2PopOut1.Text:SetText(self:GetText())
		ssoaOptions3Box2PopOut1Choice0:Hide()
	end
end)
